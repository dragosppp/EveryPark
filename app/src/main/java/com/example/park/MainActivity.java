...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean fineLocationPermision = false;
        ...
        switch (requestCode) {
            case PERMISSIONS_REQUEST_ENABLE_GPS: {
                if (!fineLocationPermision) {
                    ...
                    //ceva aici
                    Toast.makeText(this, "Aplication will not work properly without Gps permission", Toast.LENGTH_SHORT).show();
                }
            }
        }
